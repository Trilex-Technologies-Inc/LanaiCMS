...
$ajax->setJSCode("mybutton",$ajax->htmlDisable("mybutton"),$ajax->htmlEnable("mybutton")); 
...
<html>
	<head>
		<title>AjaxCore 1.1.2 » BindTimer Example</title>
	...
	<body>
		<table align="center" width="740">
			...
			<tr>
				<td class="main">
					<h2>BindTimer Example</h2>
					This is a simple example file to check out the <a href="http://ajaxcore.sourceforge.net">AjaxCore</a> framework. <br /><br />
					When the button is pressed,a <b>Timer</b> starts with the milliseconds specified on the bindTimer call, and when it get to zero, an AJAX request is being made to return a random number. <br />
					<br />
					In this case we'll use a <b>bindTimer</b> between an HTML object and a PHP function.  <br /> <br />
					...
					Press <a href="bindTimer.phps">here</a> to download this page source file, also check the stuff below for more information.<br />
