...
$ajax->setJSCode("mybutton",$ajax->htmlEnable("stoptimer"),""); // allow to stop timer, if needed
?>
<html>
	<head>
		<title>AjaxCore 1.1.2 » onLoad with BindPeriodicalTimer Example</title>
	...
	<body>
		<table align="center" width="740">
			...
			<tr>
				<td class="main">
					<h2>onLoad with BindPeriodicalTimer Example</h2>
					This is a simple example file to check out the <a href="http://ajaxcore.sourceforge.net">AjaxCore</a> framework. <br /><br />
					When the page is loaded an AJAX request is being made to return a random number within a Timer. And it will keep repeating until we stop it, aditionally in the example, there's a button to restart timer.<br /> 
					<br />
					...
					Press <a href="onLoadBindPeriodicalTimer.phps">here</a> to download this page source file, also check the stuff below for more information.<br />
