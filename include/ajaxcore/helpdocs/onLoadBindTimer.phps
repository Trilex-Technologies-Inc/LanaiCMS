...
<html>
	<head>
		<title>AjaxCore 1.1.2 » onLoad with BindTimer Example</title>
	...
	<body>
		<table align="center" width="740">
			...
			<tr>
				<td class="main">
					<h2>onLoad with BindTimer Example</h2>
					This is a simple example file to check out the <a href="http://ajaxcore.sourceforge.net">AjaxCore</a> framework. <br /><br />
					When the page is loaded an AJAX request is being made to return a random number within a Timer. <br /> 
					<br />
					In this case we'll use <b>onLoad</b> with a <b>bindTimer</b> to a PHP function.  <br /> <br />
					
					
					<?php echo $ajax->onLoad("getRandomNumber","","bindTimer","300"); /* Bind onLoad JavaScript event to a PHP function within a timer  */ ?>
					...
					Press <a href="onLoadBindTimer.phps">here</a> to download this page source file, also check the stuff below for more information.<br />
