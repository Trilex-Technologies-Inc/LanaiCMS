...
$chart [ 'chart_data' ][ 1 ][ 0 ] = "Visits";

$i=1;
while (!$rs->EOF) {
	$chart [ 'chart_data' ][ 0 ][ $i] = adodb_date2("d M y",$rs->fields['statDate']);
	$chart [ 'chart_data' ][ 1 ][ $i] = $rs->fields['statVisit'];
...
$chart[ 'live_update' ] = array ( 'url'=>"modules/log/swfgraph_visit.php?time=".time(), 'delay'=>10 );
...
$chart[ 'draw' ] = array ( array ( 'type'=>"text", 'color'=>"000000", 'alpha'=>10, 'font'=>"arial", 'rotation'=>-90, 'bold'=>true, 'size'=>75, 'x'=>-10, 'y'=>290, 'width'=>300, 'height'=>200, 'text'=>"Visits", 'h_align'=>"left", 'v_align'=>"top" ));
$chart[ 'series_gap' ] = array ( 'set_gap'=>40, 'bar_gap'=>-25 );                        
$chart [ 'series_color' ] = array ("FFCC00" , "FF6600" );
SendChartData ( $chart );
