                ...
                <div class="col-md-2 col-sm-3 col-4">
                    <div class="card h-100">
                        <?php if ($this->rs->fields['mediaType'] === 'image') { ?>
                            <img src="<?=htmlspecialchars($preview);?>" alt="<?=htmlspecialchars((string) (!empty($this->rs->fields['altText']) ? $this->rs->fields['altText'] : $this->rs->fields['origName']));?>" class="card-img-top" style="height:100px;object-fit:cover;">
                        <?php } else { ?>
