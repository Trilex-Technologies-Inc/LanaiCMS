...
/**
	 ...
	 * @version $Id: class.LRSSThaiPager.php,v 1.2 2007/06/30 14:17:04 redlinesoft Exp $
	 * @access public
	 **/
	class LRSSThaiPager extends ADODB_Pager {
		...
		function RenderGrid()
		{
			...
			<input type="hidden" name="modname" value="rssthai">
			...
			<?php global $sys_lanai; $sys_lanai->renderCsrfField('rssthai'); ?>
			<tr>
				...
				<th class="tblRowSolidTopDown" width="50%"><?=_RSS_TITLE; ?></th>
				<th class="tblRowSolidTopDown" width="20%"><?=_RSS_VIEW; ?></th>
				<th class="tblRowSolidTopDown" width="10%"><?=_RSS_WEIGHT; ?></th>
				<th class="tblRowSolidTopDown" width="10%"><?=_ORDER; ?></th>
			...
			<tr>
				<td class="tblRowDash" align="center">
					<input type="checkbox" name="mid[]"  value="<?=$this->rs->fields['rssId']; ?>"  class="radioButton" />
				</td>
				<td class="tblRowDash">
					<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/file.gif" border="0" align="absmiddle">
					<?=$this->rs->fields['rssTitle']; ?>
				</td>
				<td class="tblRowDash" align="center">				
					<?=strtoupper($this->rs->fields['rssView']); ?>
				</td>
				<td class="tblRowDash" align="center">				
					<input type="text" name="rssOrder[]" value="<?=$this->rs->fields['rssOrder']; ?>" size="1" maxlength="2" >
				...
				<?php
					if ($this->rs->fields['rssActive']=='y') {
					    ?>
						<button type="submit" onclick="return prepareActiveToggle('<?=$this->rs->fields['rssId']; ?>','n');" style="border:0;background:none;padding:0;cursor:pointer;">
						<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/ok.gif" border="0" align="absmiddle">
						</button>
						<?php
					} else {
						?>
						<button type="submit" onclick="return prepareActiveToggle('<?=$this->rs->fields['rssId']; ?>','y');" style="border:0;background:none;padding:0;cursor:pointer;">
				...
				<td class="tblRowDash" align="center">
					...
					?>
					<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=rsseditform&mid=<?=$this->rs->fields['rssId']; ?><?=$link; ?>">
